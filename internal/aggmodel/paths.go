...
// StaticChampionsPath is the artifact a reader resolves champion ids, slugs,
// names and icons from.
...
// slug rule in the project, so a link a reader generates and a file named by
// the static sync job always agree.
