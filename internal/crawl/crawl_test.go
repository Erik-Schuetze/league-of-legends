...
func TestClassify(t *testing.T) {
	tests := []struct {
		...
		{name: "401 is a key problem, not a match problem", err: &riot.StatusError{Method: "match", Status: 401}, want: failureTransient},
		{name: "403 is a key problem", err: &riot.StatusError{Method: "match", Status: 403}, want: failureTransient},
